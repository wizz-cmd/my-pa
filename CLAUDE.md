...
- **Unique ID**
- **Date/Time**
- **Type:** Information, Decision, Task OR Appointments, Reminders
- **Backlinks** to relevant notes (people, projects, locations)
...
1. Always update the journal "000-JOURNAL.md" with new information, decisions, tasks, or appointments
2. Create or update entity notes as needed (people, places, projects)
3. Maintain backlinks and cross-references for context building
4. Work towards developing deep, networked understanding of the work environment
5. Use context to inform decisions and prioritize strategically
